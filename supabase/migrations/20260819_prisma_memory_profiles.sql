...
create table if not exists public.prisma_memories (
  ...
  memory_type text not null check (memory_type in ('preference','interest','media','game','hobby','project','goal','event','achievement','routine','communication','social','inside_joke','relationship')),
