...
async function submitCreate(interaction: ButtonInteraction, draft: Draft): Promise<void> {
  ...
  if (!interaction.channelId) { await interaction.editReply({ content: "Não encontrei o canal para publicar este LFG." }); return; }
